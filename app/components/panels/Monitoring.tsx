    ...
    <div className="h-full flex flex-col space-y-6 overflow-y-auto pr-2 custom-scrollbar">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 relative min-h-[350px] bg-black border border-white/10 rounded-sm overflow-hidden group shadow-2xl">
          ...
          <iframe 
            src="http://localhost:3000/d-solo/adv9r64/sec-cluster-security-and-hardening-overview?orgId=1&from=1781408118062&to=1781429718062&timezone=browser&var-query0=&tab=queries&panelId=panel-1"
            width="100%" 
            height="100%" 
